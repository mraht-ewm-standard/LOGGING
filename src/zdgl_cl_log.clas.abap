...
CLASS zdgl_cl_log DEFINITION
  ...
  PUBLIC SECTION.
    ...
    TYPES r_log_instance     TYPE REF TO zdgl_cl_log_ewm.
    ...
    CONSTANTS: BEGIN OF mc_default,
                 log_object    TYPE balobj_d  VALUE 'ZDGL_LOG' ##NO_TEXT, " Adjust to your needs
    ...
    CONSTANTS mc_log_context_struct TYPE baltabname VALUE 'ZDGL_S_LOG_CONTEXT' ##NO_TEXT.
...
CLASS zdgl_cl_log IMPLEMENTATION.
