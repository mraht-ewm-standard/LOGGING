...
CLASS lcl_application DEFINITION FINAL.
  ...
  PRIVATE SECTION.
    CONSTANTS mc_log_context TYPE string VALUE 'ZDGL_S_LOG_CONTEXT'.
    ...
    CLASS-METHODS sel_appl_log
      ...
      EXPORTING et_header_data TYPE zdgl_tt_balhdr
                et_messages    TYPE zdgl_tt_balm
      RAISING   zcx_error.

    CLASS-METHODS export_to_excel
      IMPORTING it_messages TYPE zdgl_tt_balm
      RAISING   zcx_error.

    CLASS-METHODS filter_messages
      CHANGING ct_messages TYPE zdgl_tt_balm.
...
CLASS lcl_application IMPLEMENTATION.
  ...
  METHOD sel_appl_log.
    ...
    IF et_messages IS INITIAL.
      RAISE EXCEPTION TYPE zcx_error
        MESSAGE w000(zdgl_log) WITH TEXT-901 ##FM_SUBRC_OK.
    ENDIF.
  ...
  METHOD export_to_excel.
    ...
    MESSAGE s000(zdgl_log) WITH TEXT-100.
